...
//
// Usage:
//   node tools/run-steward-evals.cjs            # human report
//   node tools/run-steward-evals.cjs --json     # JSON for CI / scripting
//   node tools/run-steward-evals.cjs --filter=denylist   # substring filter
