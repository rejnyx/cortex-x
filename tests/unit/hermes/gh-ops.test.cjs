 ...
 *
 * Project audit (2026-05-09) flagged `bin/hermes/_lib/gh-ops.cjs` (140 LoC,
 * shipped Sprint 1.6.19) as the only `bin/hermes/_lib/` module without a
 * dedicated unit test. Coverage today is transitive via
 * `tests/unit/hermes/execute.test.cjs`, which is too coarse to catch
...
const ghOps = require('../../../bin/hermes/_lib/gh-ops.cjs');
