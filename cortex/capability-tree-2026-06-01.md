...
**Snapshot date:** `2026-06-02T20:16:51+02:00`  
**HEAD:** `04280b6` — feat(workflows): Sprint 2.44 — cortex x Claude Code dynamic workflows integration
...
| Agents (`agents/*.md`) | 9 |
| CLIs (`bin/*.cjs`) | 21 |
| Standards (`standards/*.md`) | 34 |
| Prompts (`prompts/*.md`) | 19 |
| Detectors (`detectors/*.cjs`) | 19 |
| Workflows (`.github/workflows/*.yml`) | 23 |
| Profiles (`profiles/*.yaml`) | 11 |
| Tests total (`tests/**/*.test.cjs`) | 155 |

> Test breakdown — unit 122 · contract 13 · integration 20 · smoke 0.
...
| `6b27925` | 2026-06-01T11:03:49Z | chore(capabilities): auto-regenerate registry [skip ci] |
| `44a081a` | 2026-06-01T13:03:33+02:00 | fix(ci): park stryker schedule until sandbox-vs-runtime divergence is debugged |
