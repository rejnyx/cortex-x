...
**Snapshot date:** `2026-06-03T11:42:27+02:00`  
**HEAD:** `2fceee3` — feat(docs): Sprint 2.46.2 — doc-currency lint (stale-prose detector + frontmatter expiry + R2 self-c
...
| Tests total (`tests/**/*.test.cjs`) | 162 |

> Test breakdown — unit 126 · contract 15 · integration 21 · smoke 0.
...
| SHA | Date | Subject |
|---|---|---|
| `2fceee3` | 2026-06-03T11:42:27+02:00 | feat(docs): Sprint 2.46.2 — doc-currency lint (stale-prose detector + frontmatter expiry + R2 self-c |
| `d694543` | 2026-06-03T09:11:40Z | chore(capabilities): auto-regenerate registry [skip ci] |
| `1255f41` | 2026-06-03T11:11:17+02:00 | feat(verdict): Sprint 2.46.1 — v2 schema (commit_sha + Ed25519 + nonce journal + STRICT_SECRET) + R2 |
| `ea076bf` | 2026-06-03T06:55:10Z | chore(capabilities): auto-regenerate registry [skip ci] |
| `5df034a` | 2026-06-03T08:54:55+02:00 | feat(verdict): Sprint 2.46 — signed r2-verdict.json + Sprint pipeline SSOT extraction + untrusted fe |
...
| `bin/steward/_lib/spec-verifier.cjs` | 1361 |
| `bin/steward/_lib/action-kinds.cjs` | 1002 |
| `bin/steward/_lib/autoresearch.cjs` | 839 |
| `bin/steward/dry-run.cjs` | 833 |
| `bin/cortex-doc-currency.cjs` | 826 |
| `bin/steward/_lib/test-smell-detector.cjs` | 739 |
| `bin/cortex-doc-regen.cjs` | 707 |
| `bin/steward/_lib/r2-verdict.cjs` | 676 |
