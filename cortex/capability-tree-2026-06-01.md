...
**Snapshot date:** `2026-06-03T08:54:55+02:00`  
**HEAD:** `5df034a` — feat(verdict): Sprint 2.46 — signed r2-verdict.json + Sprint pipeline SSOT extraction + untrusted fe
...
| Tests total (`tests/**/*.test.cjs`) | 159 |

> Test breakdown — unit 124 · contract 14 · integration 21 · smoke 0.
