...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-20T10:49:53.878Z
...
| GitHub workflows | 23 |
| Tests total | 2860 (unit 2683 · contract 106 · integration 71 · smoke 0) |
| Runtime LoC (`bin/`) | 32,305 |
| Test LoC (`tests/`) | 37,841 |
