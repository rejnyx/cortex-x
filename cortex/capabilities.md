...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-13T07:11:11.818Z
...
| Runtime LoC (`bin/`) | 22,550 |
| Test LoC (`tests/`) | 29,262 |
