...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-14T09:46:51.198Z
...
| GitHub workflows | 22 |
| Tests total | 2633 (unit 2456 · contract 106 · integration 71 · smoke 0) |
| Runtime LoC (`bin/`) | 29,881 |
| Test LoC (`tests/`) | 35,008 |
