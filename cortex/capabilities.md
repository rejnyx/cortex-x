...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-13T15:08:17.610Z
...
| GitHub workflows | 22 |
| Tests total | 2526 (unit 2349 · contract 106 · integration 71 · smoke 0) |
| Runtime LoC (`bin/`) | 27,798 |
| Test LoC (`tests/`) | 33,403 |
