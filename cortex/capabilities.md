...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-14T09:25:06.698Z
...
| GitHub workflows | 22 |
| Tests total | 2628 (unit 2451 · contract 106 · integration 71 · smoke 0) |
| Runtime LoC (`bin/`) | 29,789 |
| Test LoC (`tests/`) | 34,943 |
