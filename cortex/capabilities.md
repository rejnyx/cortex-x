...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-06-03T10:14:14.300Z
...
| GitHub workflows | 23 |
| Tests total | 3167 (unit 2865 · contract 113 · integration 189 · smoke 0) |
| Runtime LoC (`bin/`) | 36,079 |
| Test LoC (`tests/`) | 44,164 |
...
| [`stryker-mutation`](../.github/workflows/stryker.yml) | manual | Mutation-testing workflow — Sprint 2.3 v0 measure-only posture. |
