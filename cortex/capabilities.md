...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-13T14:52:46.652Z
...
| GitHub workflows | 22 |
| Tests total | 2519 (unit 2342 · contract 106 · integration 71 · smoke 0) |
| Runtime LoC (`bin/`) | 27,798 |
| Test LoC (`tests/`) | 33,297 |
