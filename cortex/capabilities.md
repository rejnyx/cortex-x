...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-13T16:00:28.473Z
...
| GitHub workflows | 22 |
| Tests total | 2592 (unit 2415 · contract 106 · integration 71 · smoke 0) |
| Runtime LoC (`bin/`) | 29,219 |
| Test LoC (`tests/`) | 34,401 |
