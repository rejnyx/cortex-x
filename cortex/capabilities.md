...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-13T13:34:41.123Z
...
| GitHub workflows | 22 |
| Tests total | 2469 (unit 2300 · contract 106 · integration 63 · smoke 0) |
| Runtime LoC (`bin/`) | 26,778 |
| Test LoC (`tests/`) | 32,387 |
