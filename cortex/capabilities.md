...
> **AUTO-GENERATED** by [`bin/cortex-capabilities.cjs`](../bin/cortex-capabilities.cjs). Re-run `npm run capabilities` to refresh. Last generated: 2026-05-14T09:20:06.769Z
...
| Runtime LoC (`bin/`) | 29,360 |
| Test LoC (`tests/`) | 34,562 |
